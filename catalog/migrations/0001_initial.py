...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Company',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text='Unique identifier for company.', primary_key=True, serialize=False)),
                ('Company_name', models.CharField(help_text='Enter the company name.', max_length=250)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.Product')),
            ],
        ),
        migrations.CreateModel(
            name='User',
